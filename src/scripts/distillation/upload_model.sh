...
MODEL_PATH="/home/ehghaghi/scratch/ehghaghi/distillation_results/8_coding/checkpoint-421"
HF_USERNAME="Malikeh1375"  # Change this to your HF username
REPO_NAME="Qwen2.5-1.5B-Coding-Distilled-8Clusters"
...
python3 upload_model.py \
  ...
  --commit_message "Upload fine-tuned Qwen2.5-1.5B coding model"
